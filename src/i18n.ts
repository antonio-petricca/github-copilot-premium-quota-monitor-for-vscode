...
const EN: Record<string, string> = {
    ...
    statusbar_tooltip_error: '**GitHub Copilot premium quota monitor**\n\n✗ Error: {0}',
    statusbar_tooltip_loading: '**GitHub Copilot premium quota monitor**\n\nLoading...',
    statusbar_tooltip_noaccount: '⚠ Not signed in.\n\n*Click to sign in.*',
    statusbar_tooltip_unlimited: '**GitHub Copilot premium quota monitor**\n\nUnlimited premium quota',
    statusbar_tooltip_available:
